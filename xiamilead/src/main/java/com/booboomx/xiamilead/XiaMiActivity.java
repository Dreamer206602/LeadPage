package com.booboomx.xiamilead;
...
import com.booboomx.xiamilead.fragment.VideoItemFragment;
import com.booboomx.xiamilead.indicator.CirclePageIndicator;
import com.booboomx.xiamilead.viewpager.ExtendedViewPager;

public class XiaMiActivity extends FragmentActivity implements ViewPager.OnPageChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xia_mi);
        ...
        mTvEnter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(XiaMiActivity.this, "demo就是这些，进不去了！", Toast.LENGTH_SHORT).show();
