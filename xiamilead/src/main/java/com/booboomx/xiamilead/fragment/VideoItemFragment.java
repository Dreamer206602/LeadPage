package com.booboomx.xiamilead.fragment;

import android.media.MediaPlayer;
import android.support.v4.app.FragmentActivity;
import android.widget.ImageView;

import com.booboomx.xiamilead.R;
import com.booboomx.xiamilead.XiaMiActivity;
import com.booboomx.xiamilead.videoview.FullScreenVideoView;
...
public class VideoItemFragment extends LazyLoadFragment
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        ...
        if ((localFragmentActivity != null) && ((localFragmentActivity instanceof XiaMiActivity))) {
            ((XiaMiActivity) localFragmentActivity).next(position);
        }
    }
