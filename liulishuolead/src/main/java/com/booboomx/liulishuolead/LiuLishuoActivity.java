package com.booboomx.liulishuolead;
...
import com.booboomx.liulishuolead.widget.PreviewIndicator;
import com.booboomx.liulishuolead.widget.PreviewVideoView;
...
public class LiuLishuoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liu_lishuo);
        ...
        mVpImage.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                Log.i("ssssssss", "onPageScrolled: "+position);
            }
            ...
            public void onPageSelected(int position) {
                ...
                startLoop();
                Log.i("ssssssss", "onPageSelected: "+position);

            }

            @Override
            public void onPageScrollStateChanged(int state) {
                Log.i("ssssssss", "onPageScrollStateChanged: "+state);
