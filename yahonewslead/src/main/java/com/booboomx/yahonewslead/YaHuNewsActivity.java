package com.booboomx.yahonewslead;
...
public class YaHuNewsActivity extends AppCompatActivity {
    ...
    private static  YaHuNewsActivity mInstance;
    ...
    private static float mPreviousPositionOffset;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ya_hu_news);
    ...
    private static void initThirdScreenViews(View rootView, Bundle savedInstanceState) {
        ...
        mRoundView.setContext(mInstance);
