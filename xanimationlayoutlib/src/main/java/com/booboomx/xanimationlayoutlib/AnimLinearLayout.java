package com.booboomx.xanimationlayoutlib;
...
public class AnimLinearLayout extends LinearLayout {
    ...
    private boolean isNeedWrap(ViewGroup.LayoutParams params) {
        if (params != null && params instanceof LayoutParams) {
            ...
            if (((LayoutParams) params).isScaleX()
                    || ((LayoutParams) params).isScaleY()
                    || ((LayoutParams) params).isRotate()
                    || ((LayoutParams) params).isAlpha()
                    || ((LayoutParams) params).isBgGradient()
                    || ((LayoutParams) params).isTranslate())
                return true;
        }
        return false;
    }
